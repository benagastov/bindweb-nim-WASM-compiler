...
##
## NOTE (libpack staging): the upstream `{.compile: "../bindweb_runtime.c".}`
## pragma is intentionally removed here. Its relative path cannot resolve once
## this file is mounted at /bindweb, and the web pipeline compiles
## c/bindweb_runtime.c directly (SPEC section 6.3). The legacy IDE bundle
